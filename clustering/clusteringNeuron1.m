...
for i = 1:length(fileList)
    ...
    trigger = {odorOn(trialType==1)
     ...
     for k = 1:binNum
            ...
            auROCvalue(4,i,k) = auROC(s,baseline);
...
dataToCluster = [squeeze(auROCvalue(4,:,1:40)) ...
    squeeze(auROCvalue(3,:,30:40))];
...
for j = 1:3
    ...
    if j ==1
        titleText = '90% reward ROC';
    elseif j==2
        titleText = '90% no reward ROC';
    elseif j==3   
        titleText = 'Airpuff ROC';
    end
    hold on;
