...
[eigvect,proj,eigval] = princomp(squeeze(auROCvalue(1,:,10:30)));
dataToCluster = proj(:,1:4);
...
[~,plotorder] = sort(mean(squeeze(auROCvalue(1,:,10:30)),2));
%find out light response neurons index
idx = ismember(fileList,identifyDataNames);
idx = idx(plotorder);
