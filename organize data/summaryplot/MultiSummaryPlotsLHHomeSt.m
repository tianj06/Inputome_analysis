...
formattedDataPath = 'D:\Dropbox (Uchida Lab)\lab\FunInputome\rabies\rabies_Striatum\formatted\';
analyzedDataPath = 'D:\Dropbox (Uchida Lab)\lab\FunInputome\rabies\rabies_Striatum\analysis\'

%externalDrives = setdiff( getdrives, {'c:\','d:\'});
rawPath = {'K:\St\','N:\rabies\'};

figureSavePath = 'D:\Dropbox (Uchida Lab)\lab\FunInputome\rabies\rabies_Striatum\unitSummary\';
%%
